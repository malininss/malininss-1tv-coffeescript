...
updateDayProgram = function updateDayProgram(date, schedule) {
  ...
  widgetTitleSpan.textContent += ". ".concat(widgetTitleSpanText[0].toUpperCase() + widgetTitleSpanText.slice(1));
